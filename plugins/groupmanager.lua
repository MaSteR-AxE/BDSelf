...
if ((matches[1] == "add"  ) or (matches[1] == "افزودن"  )) then
return modadd(msg)
end
...
if ((matches[1] == "setowner"  ) or (matches[1] == 'مالک'  )) and is_admin(msg) then
...
if ((matches[1] == "promote"  ) or (matches[1] == "مدیر"  )) and is_owner(msg) then
if not matches[2] and msg.reply_id then
    tdcli_function ({
      ID = "GetMessage",
      chat_id_ = msg.to.id,
...
if ((matches[1] == "unlock"  ) or (matches[1] == "باز کردن"  )) and is_mod(msg) then
local target = msg.to.id
if ((matches[2] == "link"  ) or (matches[2] == "لینک"  )) then
...
if ((matches[2] == "gif"  ) or (matches[2] == "تصاویر متحرک"  )) then
...
if ((matches[2] == "sticker"  ) or (matches[2] == "برچسب"  )) then
return mute_sticker(msg ,data, target)
end
if ((matches[2] == "contact"  ) or (matches[2] == "مخاطب"  )) then
return mute_contact(msg ,data, target)
end
if ((matches[2] == "forward"  ) or (matches[2] == "نقل قول"  )) then
...
if ((matches[2] == "inline"  ) or (matches[2] == "کیبورد شیشه ای"  )) then
...
if ((matches[1] == "unmute"  ) or (matches[1] == "باصدا"  )) and is_mod(msg) then
local target = msg.to.id
if ((matches[2] == "all"  ) or (matches[2] == "همه"  )) then
...
if ((matches[1] == 'newlink'  ) or (matches[1] == "لینک جدید"  )) and is_mod(msg) then
 ...
 tdcli.exportChatInviteLink(msg.to.id, callback_link, nil)
   ...
   local is_link = msg.text:match("^([https?://w]*.?telegram.me/joinchat/%S+)$") or msg.text:match("^([https?://w]*.?t.me/joinchat/%S+)$")
    ...
    if ((matches[1] == 'linkpv'  ) or (matches[1] == "لینک خصوصی"  )) and is_mod(msg) then
      local linkgp = data[tostring(chat)]['settings']['linkgp']
      if not linkgp then
      if not lang then
        return "_First create a link for group with using_ /newlink\n_If bot not group creator set a link with using_ /setlink"
...
if ((matches[1] == "res"  ) or (matches[1] == "کاربری"  )) and matches[2] and is_mod(msg) then
    tdcli_function ({
      ID = "SearchPublicChat",
      username_ = matches[2]
    }, action_by_username, {chat_id=msg.to.id,username=matches[2],cmd="res"})
  end
if ((matches[1] == "whois"  ) or (matches[1] == "شناسه"  )) and matches[2] and is_mod(msg) then
tdcli_function ({
    ID = "GetUser",
    user_id_ = matches[2],
  }, action_by_id, {chat_id=msg.to.id,user_id=matches[2],cmd="whois"})
  end
		if ((matches[1]:lower() == 'setchar'  ) or (matches[1] == "حداکثر حروف مجاز"  )) then
			if not is_mod(msg) then
				return
			end
    ...
    return "_حداکثر زمان بررسی پیام های مکرر تنظیم شد به :_ *[ "..matches[2].." ]*"
     ...
     if not lang then
       ...
       if not lang then
			...
			if ((matches[2] == 'welcome'  ) or (matches[2] == "خوشامد"  )) then
...
tdcli.changeChatTitle(chat, gp_name, dl_cb, nil)
  ...
  if ((matches[1] == "about"  ) or (matches[1] == "درباره"  )) and msg.to.type == "chat" and is_owner(msg) then
 if not data[tostring(chat)]['about'] then
     if not lang then
  ...
  if ((matches[1] == 'unfilter'  ) or (matches[1] == "حذف فیلتر"  )) and is_mod(msg) then
...
if ((matches[1] == "mutelist"  ) or (matches[1] == "لیست بیصدا"  )) and is_mod(msg) then
return mutes(msg, target)
end
if ((matches[1] == "modlist"  ) or (matches[1] == "لیست مدیران"  )) and is_mod(msg) then
return modlist(msg)
end
if ((matches[1] == "ownerlist"  ) or (matches[1] == "لیست مالکان"  )) and is_owner(msg) then
return ownerlist(msg)
end
if ((matches[1] == "whitelist"  ) or (matches[1] == "لیست سفید"  )) and not matches[2] and is_mod(msg) then
...
if (matches[1] == 'زبان'  ) and is_owner(msg) then
local hash = "gp_lang:"..msg.to.id
...
if (matches[1]:lower() == "setcmd"  ) and is_owner(msg) then
...
if (matches[1]:lower() == "دستورات انگلیسی"  ) and is_owner(msg) then
local hash = "cmd_lang:"..msg.to.id
redis:del(hash)
   if lang then
...
--------------------- Welcome -----------------------
	if ((matches[1] == "welcome"  ) or (matches[1] == "خوشامد"  )) and is_mod(msg) then
	...
	if ((matches[1] == "setwelcome"  ) or (matches[1] == "تنظیم خوشامد"  )) and matches[2] and is_mod(msg) then
 ...
 if checkmod and msg.text and msg.to.type == 'channel' then
	...
	local secchk = true
		...
		if secchk then
			checkmod = false
			if not lang then
				return tdcli.sendMessage(msg.to.id, 0, 1, '', 1, "md")
			else
				return tdcli.sendMessage(msg.to.id, 0, 1, '', 1, "md")
			end
		end
